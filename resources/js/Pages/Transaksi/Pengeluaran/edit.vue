    ...
    <blankVue>
       ...
       <template v-slot:konten>
            <form
                ...
                @submit.prevent="form.put(route('transaksipengeluaran.update',{pengeluaran:form.id}))"
            >
               <h3 class="font-bold text-lg mb-1">Nama Produk</h3>
                ...
                <input
                    ...
                    class="input input-bordered w-full mb-2"
                />
                <h3 class="font-bold text-lg mb-1 capitalize">jumlah</h3>
                <input
                    type="number"
                    v-model="form.jumlah"
                    name="jumlah"
                    ...
                    class="input input-bordered w-full mb-2"
                />
                <h3 class="font-bold text-lg mb-1 capitalize">total</h3>
                <input
                    type="number"
                    v-model="form.total"
                    name="total"
                    ...
                    class="input input-bordered w-full mb-2"
                />
                <h3 class="font-bold text-lg mb-1 capitalize">keterangan</h3>
                <input
                    type="text"
                ...
                <div class="modal-action">
                    ...
                    <Link :href="route('transaksipengeluaran.index')">
...
export default {
    ...
    mounted() {
        ...
        this.form.nama = this.pengeluaran.nama;
        this.form.harga = this.pengeluaran.harga;
        this.form.jumlah = this.pengeluaran.jumlah;
